...
if ($activeRole === 'admin' || $activeRole === 'sub_admin') {
    $navItems = [
        ...
        ['section' => 'Manage'],
        ['key' => 'leads',       'label' => 'Leads',        'href' => $basePath . '/admin/dashboard.php#leads',     'icon' => $icons['leads']],
        ['key' => 'clients',     'label' => 'Clients',      'href' => $basePath . '/admin/dashboard.php#clients',   'icon' => $icons['clients']],
        ['key' => 'tasks',       'label' => 'Tasks',        'href' => $basePath . '/admin/dashboard.php#tasks',     'icon' => $icons['tasks']],
        ['key' => 'followups',   'label' => 'Follow-ups',   'href' => $basePath . '/admin/dashboard.php#followups', 'icon' => $icons['followups']],
        ['section' => 'Organization'],
        ['key' => 'users',       'label' => 'Employees',    'href' => $basePath . '/admin/dashboard.php#users',      'icon' => $icons['users']],
        ['key' => 'branches',    'label' => 'Branches',     'href' => $basePath . '/admin/dashboard.php#branches',   'icon' => $icons['branches']],
        ['key' => 'categories',  'label' => 'Categories',   'href' => $basePath . '/admin/dashboard.php#categories', 'icon' => $icons['categories']],
        ['section' => 'Analytics'],
        ['key' => 'leaderboard', 'label' => 'Leaderboard',  'href' => $basePath . '/admin/dashboard.php#leaderboard','icon' => $icons['leaderboard']],
        ['key' => 'sheets',      'label' => 'Sheets',       'href' => $basePath . '/admin/dashboard.php#sheets',     'icon' => $icons['sheets']],
    ];
    ...
    $navItems = [
        ...
        ['section' => 'My Work'],
        ['key' => 'leads',       'label' => 'My Leads',     'href' => $basePath . '/employee/dashboard.php#leads',     'icon' => $icons['leads']],
        ['key' => 'clients',     'label' => 'My Clients',   'href' => $basePath . '/employee/dashboard.php#clients',   'icon' => $icons['clients']],
        ['key' => 'tasks',       'label' => 'My Tasks',     'href' => $basePath . '/employee/dashboard.php#tasks',     'icon' => $icons['tasks']],
        ['key' => 'followups',   'label' => 'Follow-ups',   'href' => $basePath . '/employee/dashboard.php#followups', 'icon' => $icons['followups']],
        ['section' => 'Performance'],
        ['key' => 'leaderboard', 'label' => 'Leaderboard',  'href' => $basePath . '/employee/dashboard.php#leaderboard','icon' => $icons['leaderboard']],
        ['key' => 'points',      'label' => 'My Points',    'href' => $basePath . '/employee/dashboard.php#points',     'icon' => $icons['points']],
    ];
    ...
    $navItems = [
        ...
        ['section' => 'My Account'],
        ['key' => 'profile',       'label' => 'My Profile',     'href' => $basePath . '/client/dashboard.php#profile',      'icon' => $icons['profile']],
        ['key' => 'followups',     'label' => 'Follow-ups',     'href' => $basePath . '/client/dashboard.php#followups',    'icon' => $icons['followups']],
        ['key' => 'notifications', 'label' => 'Notifications',  'href' => $basePath . '/client/dashboard.php#notifications','icon' => $icons['notifications']],
    ];
}
?>
